...
const DeliveryHeader = () => {
  ...
  const menuItems = useMemo(
    () => [
      ...
      { name: "Available Orders", path: "/delivery/available-orders" },
      { name: "Available Repair Requests", path: "/delivery/available-repair-requests" },
      { name: "My Orders", path: "/delivery/my-deliveries" },
      { name: "My Repairs", path: "/delivery/my-repairs" },
    ],
    []
  );
