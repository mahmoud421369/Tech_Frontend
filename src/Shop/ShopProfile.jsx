...
const updateShop = async () => {
  ...
  className="min-h-screen p-6 font-cairo bg-gray-50 dark:bg-gray-900 transition-colors"
>
  <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">

    <div className="lg:col-span-2 bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg text-right">
      <h1 className="text-white px-4 py-2 bg-blue-500 rounded-md font-bold text-3xl inline-block mb-6">
        حسابك
      </h1>
      ...
      <div className="space-y-6">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-3 py-3 rounded-xl bg-[#ECF0F3] dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 focus:outline-none"
    ...
    <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg text-right">
      <h2 className="text-white px-4 py-2 bg-blue-500 rounded-md font-bold text-2xl inline-block mb-6">
        فروع المتجر
      </h2>
      ...
      {addresses.map((addr) => (
        <div
          key={addr.id}
          className="rounded-xl p-4 mb-4 bg-blue-50 dark:bg-gray-700 text-blue-600 dark:text-blue-300 font-bold"
        >
          {editingAddressId === addr.id ? (
            <div className="grid grid-cols-2 gap-3">
              <input
                ...
                placeholder="الولاية"
                className="block w-full pl-10 pr-3 py-3 rounded-xl bg-white dark:bg-gray-600 dark:text-white focus:ring-2 focus:ring-blue-500 focus:outline-none"
              />
              <input
                type="text"
              ...
              <button
                ...
                className="bg-emerald-100 dark:bg-emerald-600/20 border-emerald-400 text-emerald-500 dark:text-emerald-300 font-bold px-3 py-2 rounded-lg"
              >
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="bg-white dark:bg-gray-600 text-amber-500 px-3 py-2 rounded-3xl"
                >
                  <FiEdit3 />
                </button>
                <button
                  onClick={() => deleteAddress(addr.id)}
                  className="bg-white dark:bg-gray-600 text-red-500 px-3 py-2 rounded-3xl"
                >
                  <FiTrash2 />
                </button>
              </div>
      ...
      <div className="bg-gray-50 dark:bg-gray-700 shadow rounded-xl p-6 mt-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <input
            ...
            placeholder="الولاية"
            className="block w-full pl-10 pr-3 py-3 rounded-xl bg-[#ECF0F3] dark:bg-gray-600 dark:text-white focus:ring-2 focus:ring-blue-500 focus:outline-none"
          />
          <input
            type="text"
        ...
        <label className="flex items-center gap-2 mb-4 text-right text-gray-700 dark:text-gray-300">
          <input
            type="checkbox"
