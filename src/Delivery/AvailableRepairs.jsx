        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-600">Operations</span>
            </div>
            <h1 className="text-4xl font-black text-gray-900 dark:text-white tracking-tighter">Available <span className="text-emerald-500">Repairs</span></h1>
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                {isLoading && paginated.length === 0 ? (
                  ...
                  paginated.map(repair => (
                    <tr key={repair.id} className="hover:bg-emerald-50/10 dark:hover:bg-emerald-900/5 transition-colors group">
                      <td className="px-4 py-3 whitespace-nowrap ">
                        <p className="text-xs  text-gray-950 dark:text-white uppercase">{formatDate(repair.createdAt)}</p>
                      ...
                      <td className="px-4 py-3 whitespace-nowrap">
                        <div className="flex items-center justify-center gap-3">
                          ...
                          <div>
                            <p className="text-xs font-black text-gray-700 dark:text-gray-100 leading-none mb-1.5">{repair.firstName} {repair.lastName}</p>
                            <div className="flex items-center gap-1.5">
                              <span className="text-[10px] font-mono text-gray-400">{repair.phone || "Not specified"}</span>
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-xs font-black text-gray-950 dark:text-white truncate max-w-[200px]">{repair.shopAddress?.street || "Tech Station"}</p>
                            <p className="text-[10px] font-bold text-gray-600 mt-0.5 uppercase tracking-widest">{repair.shopAddress?.city || "Area Hub"}</p>
                          </div>
                        </div>
                      </td>
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-xs font-black text-gray-950 dark:text-white truncate max-w-[200px]">{repair.deliveryAddress?.street || "Customer Site"}</p>
                            <p className="text-[10px] font-bold text-gray-600 mt-0.5 uppercase tracking-widest">{repair.deliveryAddress?.city || "Destination"}</p>
                          </div>
                        </div>
                      </td>
                      <td className="px-4 py-3 whitespace-nowrap">
