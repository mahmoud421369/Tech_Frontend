...
const AssignedRepairs = ({ darkMode }) => {
    ...
    try {
      ...
      if (err.response?.status === 401) {
        ...
        Swal.fire({
          ...
          text: err.response?.data?.message || 'Invalid delivery ID or no repairs found',
          toast: true,
          position: 'top-end'
        });
        setRepairs([]);
  ...
  const currentRepairs = repairs.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mb-12 text-center lg:text-left">
          ...
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">
            View all repair pickup/delivery tasks assigned to an agent
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-2xl font-semibold text-gray-600 dark:text-gray-400">
              {deliveryId ? 'No repairs found for this agent' : 'Enter a Delivery ID to view assigned repairs'}
            </h3>
