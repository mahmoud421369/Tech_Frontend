    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 lg:pl-64 mt-16 transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-8">
        ...
        <div className="relative bg-white dark:bg-gray-800 rounded-[2.5rem] border border-gray-100 dark:border-gray-700 shadow-xl shadow-gray-200/20 dark:shadow-none overflow-hidden p-8 group">
          <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-500/5 rounded-bl-full translate-x-16 -translate-y-16 group-hover:translate-x-8 group-hover:-translate-y-8 transition-transform duration-700" />

          <div className="relative flex flex-col md:flex-row items-center gap-8">
            <div className="relative">
              <div className="w-32 h-32 rounded-[2.5rem] bg-transparent p-1">
              ...
              <div className={`absolute -bottom-2 -right-2 -left-2 text-center px-4 py-1.5 rounded-2xl text-[10px] font-black uppercase tracking-widest border shadow-lg ${statusStyle.bg} ${statusStyle.border} ${statusStyle.text}`}>
                {profile.status}
              </div>
            </div>
            ...
            {!isEditing && (
              <button
                ...
                className="px-6 py-3 rounded-2xl bg-gray-900 dark:bg-emerald-500 text-white dark:text-white text-sm font-black hover:bg-emerald-500 transition-all shadow-xl shadow-gray-200 dark:shadow-none active:scale-95"
              >
                Edit Account
              </button>
            )}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-[2.5rem] border border-gray-100 dark:border-gray-700 shadow-sm p-8 space-y-8">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-black text-gray-900 dark:text-white tracking-tight">Assigner Info</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-2">
              ...
              {isEditing
                ...
                : <div className={readClass}><FiUser className="text-lime-500" /> {profile.name || 'Not Specified'}</div>}
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className={readClass}><FiMail className="text-orange-500" /> {profile.email || 'Not Specified'}</div>
            </div>
            ...
            <div className="space-y-2">
              ...
              {isEditing
                ...
                : <div className={readClass}><FiPhone className="text-emerald-500" /> {profile.phone || 'No phone number'}</div>}
            </div>

            <div className="space-y-2">
              <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1">Access Level</label>
              <div className={readClass}><FiShield className="text-purple-500" /> Full Permissions</div>
            </div>
          ...
          {isEditing && (
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button
                ...
                disabled={isLoading}
                className="flex-1 flex items-center scale-80 justify-center gap-2 px-8 py-4 rounded-md bg-emerald-500 hover:bg-emerald-600 disabled:opacity-50 text-white font-black transition-all shadow-lg shadow-emerald-500/20 active:scale-95"
              >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 p-6 flex items-center justify-between group">
            <div className="space-y-1">
              ...
              <p className={`text-sm font-black ${profile.activate ? 'text-indigo-500' : 'text-red-500'}`}>
                {profile.activate ? 'Active ' : 'Deactivated'}
              </p>
            </div>
