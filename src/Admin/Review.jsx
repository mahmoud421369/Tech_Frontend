        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-lime-600">Public Sentiment</span>
            </div>
                ...
                <table className="w-full min-w-[850px]">
                  ...
                  <tbody className="divide-y divide-gray-50 dark:divide-gray-800">
                    {paginated.length === 0 ? (
                      ...
                      <tr key={review.id} className="hover:bg-lime-50/10 dark:hover:bg-lime-900/5 transition-colors group">
                        ...
                        <td className="px-6 py-5">
                          <div className="flex items-center justify-center gap-2">
                            <button onClick={() => setSelected(review)}
                              ...
                              <FiInfo size={16} title="Audit Narrative" />
                            </button>
                            <button onClick={() => deleteReview(review.id)}
                              ...
                              <FiTrash2 size={16} title="Purge Feedback" />
                            </button>
                          </div>
                        </td>
                      </tr>
