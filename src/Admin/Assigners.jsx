...
const Assigners = () => {
  ...
  const fetchAssigners = async () => {
    ...
    try {
      ...
      const totalHandled = data.content.reduce((sum, a) => sum + (a.totalAssignmentsHandled || 0), 0);
      const pending = data.content.reduce((sum, a) => sum + (a.pendingAssignments || 0), 0);
      const verified = data.content.filter(a => a.status === "APPROVED").length;
      ...
      className="space-y-6 p-6 max-w-8xl min-h-screen w-full mx-auto dark:bg-gray-900 bg-gray-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
            <h3 className="text-lg font-semibold text-blue-500">Total Assignments Handled</h3>
            <p className="text-2xl font-bold text-gray-800 dark:text-gray-200">{stats.totalAssignmentsHandled}</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
            <h3 className="text-lg font-semibold text-blue-500">Pending Assignments</h3>
            <p className="text-2xl font-bold text-gray-800 dark:text-gray-200">{stats.pendingAssignments}</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
            <h3 className="text-lg font-semibold text-blue-500">Verified Assigners</h3>
            <p className="text-2xl font-bold text-gray-800 dark:text-gray-200">{stats.verifiedAssigners}</p>
          </div>
        </div>
