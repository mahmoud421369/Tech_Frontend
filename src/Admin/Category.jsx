      ...
      <td className="px-6 py-5">
        <div className="flex justify-center items-center gap-3">
          <button
            ...
            className="text-emerald-600 dark:bg-gray-950 dark:text-white dark:border-gray-900 hover:text-emerald-800 flex items-center gap-1 text-xs px-3 py-1.5 bg-emerald-50 rounded-lg font-medium border border-emerald-200"
          >
