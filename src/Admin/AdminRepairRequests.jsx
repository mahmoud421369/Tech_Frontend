        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-600">Maintenance Oversight</span>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm p-4">
          <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
            <div className="relative flex-1 group">
              ...
              <input type="text" placeholder="Search requests by shop, issue description, or ticket ID..." value={search}
              ...
              <div className="overflow-x-auto w-full rounded-sm border border-gray-200 dark:border-gray-800 shadow-sm custom-scrollbar-thin">
                <table className="w-full table-auto border-collapse text-center text-sm text-gray-500  min-w-[900px]">
                  <thead className="bg-gray-50 dark:bg-gray-900">
                    <tr>
                      <th className={`text-slate-500 font-medium text-xs tracking-wider uppercase border-b border-slate-200 dark:border-slate-800  p-4   cursor-pointer select-none hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors `}>Ticket ID</th>
                      <Th field="shopName"       label="Shop"      center={true} onSort={handleSort} sortField={sortField} sortDir={sortDir} />
                      <Th field="description"    label="Issue"     center={true} onSort={handleSort} sortField={sortField} sortDir={sortDir} />
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                    {paginated.length === 0 ? (
                      ...
                      return (
                        <tr key={req.id} className="hover:bg-emerald-50/10 dark:hover:bg-emerald-900/5 transition-colors group">
                          <td className="p-3">
                          ...
                          <td className="p-3">
                            <p className="text-xs font-semibold text-gray-900 dark:text-white tracking-tight">{sanitize(req.shopName || 'Unknown Merchant')}</p>
                          </td>
                          <td className="p-3">
