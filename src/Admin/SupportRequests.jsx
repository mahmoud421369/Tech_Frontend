...
import { FiSearch,FiMessageSquare,FiClock,FiCheckCircle } from "react-icons/fi"
const SupportRequests = () => {
  ...
  return (
    <div style={{marginTop:"-550px",marginLeft:"300px"}} className="p-6 space-y-6">
      <div>
      ...
      <div className="bg-white shadow rounded-xl p-4 space-y-4">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead>
              <tr className="bg-gray-100 px-6 py-3 text-center text-xs font-normal  text-gray-500 uppercase tracking-wider">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredRequests.map((request) => (
                <tr key={request.id} className="border-b text-sm">
                  ...
                  <td className="p-2">{request.assignedTo}</td>
