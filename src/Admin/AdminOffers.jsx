        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-600">Promotion Oversight</span>
            </div>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              {[{ v: 'all', l: 'All' }, { v: 'active', l: 'Active' }, { v: 'expired', l: 'Expired' }].map(({ v, l }) => (
                <button key={v} onClick={() => { setStatusFilter(v); setCurrentPage(1); }}
                  className={`px-4 py-2.5 rounded-2xl text-[10px] font-black uppercase tracking-widest border transition-all ${statusFilter === v ? 'bg-emerald-500 border-emerald-500 text-white shadow-lg shadow-emerald-500/20' : 'border-transparent bg-gray-50 dark:bg-gray-900/50 text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800'}`}>
                  {l}
                </button>
              ))}
            </div>
                ...
                <table className="w-full table-auto border-collapse text-center text-sm text-gray-500  min-w-[900px]">
                  <thead className="bg-gray-50 dark:bg-gray-900">
                    <tr>
                      ...
                      <Th field="name"          label="Title"    center={true} onSort={handleSort} sortField={sortField} sortDir={sortDir} />
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                    {paginated.length === 0 ? (
                      ...
                      return (
                        <tr key={offer.id} className="hover:bg-emerald-50/10 dark:hover:bg-emerald-900/5 transition-colors group">
                          <td className="p-3">
                          ...
                          <td className="p-3">
                            <p className="text-xs font-semibold text-gray-900 dark:text-white tracking-tight max-w-[160px] truncate">{offer.name || 'Unnamed'}</p>
                          </td>
                          <td className="p-3 text-center">
                            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 border border-emerald-500/10">
                              {discountText} OFF
                            </span>
                          </td>
                          <td className="p-3 text-center">
