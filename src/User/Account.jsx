...
const [repairRequests, setRepairRequests] = useState([]);
  ...
  //         if (
  //           selectedShop &&
  //           (body.senderId === selectedShop.id || body.recipientId === selectedShop.id)
  //         ) {
  ...
  // const loadMessages = (shop) => {
  //   setSelectedShop(shop);
  //   fetch(`http://localhost:8080/api/chats/messages/${userId}/${shop.id}`, {
  //     headers: { Authorization: `Bearer ${token}` },
  //   })
  //     .then((res) => res.json())
  ...
  // const sendMessage = () => {
  //   if (!input.trim() || !selectedShop) return;
  //   const msg = {
  //     senderId: userId,
  //     recipientId: selectedShop.id,
  //     senderName: "User",
  ...
  //   setMessages((prev) => [...prev, { ...msg, status: "SENT", timestamp: new Date() }]);
  //   setInput("");
  // };
          ...
          <div className="bg-white dark:bg-gray-950 rounded-lg p-6">
            <div className="flex justify-between items-center flex-wrap gap-4 mb-6">
              ...
              <button 
                ...
                className="flex items-center gap-2 bg-blue-50  text-blue-600 px-4 py-2 rounded-md"
              >
...
>
  <FiInfo/>
                  ...
                  {/* <button
                    ...
                    className="px-4 py-2 bg-white text-indigo-600 font-bold rounded-lg shadow flex items-center gap-1"
                  >
                    <FiTruck /> Track
                  </button> */}
                  <button
