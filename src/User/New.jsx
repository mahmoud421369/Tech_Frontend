  ...
  return (
    <div className={`container-fluid  ${darkMode ? 'bg-gray-900' : 'bg-gradient-to-br from-white to-indigo-50'} mx-auto mt-6 p-4 md:p-6`}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-950 dark:border-gray-800 p-5 rounded-xl shadow-lg mb-8 border border-indigo-100">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredDevices.map(device => (
            <div
              key={device.id}
              className="bg-white dark:bg-gray-950 dark:border-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1 border-2 border-gray-100"
          ...
          <div className="relative overflow-hidden rounded-lg">
            ...
            >
              {mostPurchasedDevices.map((device, index) => (
                ...
                >
                  <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md overflow-hidden">
                    <div className="h-64 bg-white dark:bg-gray-950 dark:border-gray-800 border-2 border-gray-200 p-4 rounded-xl flex items-center justify-center relative">
                      {!imageLoadStatus[`most-${device.id}`] && (
                        <div className="absolute inset-0 flex items-center justify-center">
                          <svg 
                            className="animate-spin h-10 w-10 text-blue-600" 
